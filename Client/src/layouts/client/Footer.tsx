      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link
              to="/"
              className="text-3xl font-serif italic tracking-tighter text-white hover:opacity-80 transition-opacity"
            >
              DressUp.
            </Link>
            <p className="mt-8 text-[11px] leading-relaxed text-gray-300 uppercase tracking-[0.2em] font-light">
              Nền tảng thuê trang phục thiết kế cao cấp dành cho những dịp đặc
              biệt. Nơi phong cách và sự bền vững giao thoa.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-4 text-[11px] text-gray-300 uppercase tracking-[0.2em] font-light">
              <li>
                <Link
                  to="/catalog"
                  className="hover:text-white transition-all underline-offset-8 hover:underline"
                >
                  Tất cả sản phẩm
                </Link>
              </li>
          ...
          <div className="space-y-8">
            ...
            <p className="text-[11px] text-gray-300 font-light leading-relaxed">
              Đăng ký để nhận thông tin về các bộ sưu tập giới hạn.
            </p>
