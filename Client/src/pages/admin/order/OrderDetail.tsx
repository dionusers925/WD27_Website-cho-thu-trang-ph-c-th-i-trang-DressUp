              ...
              return (
                <div className="mx-4 my-3 bg-teal-50 border border-teal-200 rounded-xl p-4 flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-4 pt-4 border-t border-dashed border-teal-200">
                      <div className="text-[10px] font-black text-teal-700 uppercase tracking-widest mb-3 flex items-center gap-2">
                        ...
                        Minh chứng chuyển cọc (Hoàn cọc)
                      </div>

                      {order.depositReturnProof ? (
                        <div className="relative group aspect-video rounded-xl overflow-hidden border-2 border-teal-100 bg-white shadow-sm ring-1 ring-teal-50">
                          <img
                        ...
                        <div className="space-y-3">
                          {depositReturnFile ? (
                            <div className="relative aspect-video rounded-xl overflow-hidden border-2 border-orange-200 bg-white shadow-md animate-in zoom-in-95 duration-200">
                            ...
                            <div
                              ...
                              className="cursor-pointer border-2 border-dashed border-teal-200 rounded-xl p-4 text-center bg-white/50 hover:bg-teal-50 hover:border-teal-400 transition-all group"
                            >
                              <div className="text-2xl mb-1 group-hover:scale-110 transition-transform">💸</div>
                              <div className="text-[10px] font-bold text-teal-600 uppercase tracking-wider">Tải ảnh chuyển khoản</div>
                              <input
                                type="file"
                                accept="image/*"
                        ...
                        <div className="text-[11px] text-gray-400 italic bg-gray-50/50 p-3 rounded-lg border border-gray-100 text-center">
                          Chưa có minh chứng chuyển cọc
                        </div>
                      )}
                    </div>
                  </div>
