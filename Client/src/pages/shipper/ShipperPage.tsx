...
export default function ShipperPage() {
  ...
  const handleUpdateStatus = async (order: Order) => {
    ...
    try {
      ...
      showToast(
        `✅ Đơn #${(order.orderNumber || order._id).slice(-6).toUpperCase()} → ${statusMeta[next].label}`
      );
      fetchOrders();
      setExpandedId(null);
    } catch {
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "24px 16px" }}>
          ...
          {(["preparing", "shipped", "delivered"] as const).map((s) => {
            ...
            return (
              <div
                ...
                style={{
                  background: activeTab === s ? m.bg : "rgba(255,255,255,0.04)",
                  border: `1.5px solid ${activeTab === s ? m.color : "rgba(255,255,255,0.07)"}`,
                  borderRadius: 14,
                  padding: "14px 12px",
                  textAlign: "center",
                  cursor: "pointer",
              ...
              >
                ...
                <div
                  style={{
                    fontSize: 26,
                    fontWeight: 900,
                    color: activeTab === s ? m.color : "#e2e8f0",
                    lineHeight: 1.2,
                  }}
                >
                  {counts[s]}
                ...
                <div
                  style={{
                    fontSize: 10,
                    fontWeight: 700,
                    color: activeTab === s ? m.color : "#64748b",
        ...
        >
          ...
          >
            ...
            <span
              style={{
                background: statusMeta[activeTab].bg,
                color: statusMeta[activeTab].color,
                border: `1px solid ${statusMeta[activeTab].color}`,
                borderRadius: 20,
                padding: "2px 10px",
                fontSize: 12,
                fontWeight: 700,
            ...
            {filtered.map((order) => {
              ...
              return (
                <div
                  ...
                  style={{
                    background: "rgba(255,255,255,0.04)",
                    border: `1.5px solid ${isExpanded ? m.color : "rgba(255,255,255,0.08)"}`,
                    borderRadius: 16,
                    overflow: "hidden",
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <div style={{ fontWeight: 700, fontSize: 13, color: "#a3e635" }}>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div style={{ fontSize: 10, color: "#475569", fontWeight: 600 }}>
                                    Cọc: {formatCurrency(item.deposit)}
                                  </div>
                                </div>
                              </div>
                            ))}
                      ...
                      <div
                        style={{
                          ...
                          borderRadius: 10,
                          padding: "10px 14px",
                          marginBottom: order.note ? 12 : 16,
                        }}
                      >
                        <span style={{ fontWeight: 700, fontSize: 13, color: "#a5b4fc" }}>
                          💰 Tổng đơn hàng
                        </span>
                        <span style={{ fontWeight: 900, fontSize: 16, color: "#818cf8" }}>
                      ...
                      {canAdvance && (
                        ...
                        >
                          {isUpdating ? "⏳ Đang cập nhật..." : `${nextLabel[order.status || ""]} →`}
                        </button>
                      )}
